    ...
    return (
        <Card>
            ...
            <View className="w-full bg-red-400/40 rounded-2xl p-3">
                <Text className="text-red-300 text-base font-semibold">{mistakes.amount && mistakes.mistakes ? `${mistakes.mistakes} errores han sumado ${mistakes.amount}€` : "No hay errores"}</Text>
            </View>
            <View className="flex-row gap-3">
                <View className="flex-1 w-1/2">
                    ...
                    <TextInput
                        ...
                        onChangeText={value => handleChange('mistakes', 'mistakes', value)}
