        ...
        <Screen className="">
            ...
            <ScrollView className="">
                ...
                <Link asChild href="/income">
                    <Pressable onPress={() => deleteBilling(id)} className="bg-red-400 p-3 rounded-xl">
                        <Text className="text-white text-center text-xl font-semibold">Borrar facturación</Text>
                    </Pressable>
                </Link>
            </ScrollView>
        </Screen>
